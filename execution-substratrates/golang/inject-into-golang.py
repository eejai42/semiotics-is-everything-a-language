...
def main():
    ...
    write_readme(
        candidate_name,
        f"Go calculation library generated from the Effortless Rulebook.\n\n"
        f"Generated SDK for {len(table_names)} tables with {total_calc_fields} total calculation functions.\n\n"
        "Architecture:\n"
