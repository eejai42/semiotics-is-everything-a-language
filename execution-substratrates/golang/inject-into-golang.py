...
def main():
    ...
    # Note: erb_test, test-answers.json, test-results.md are build/test outputs, not generated here
    GENERATED_FILES = [
        'erb_sdk.go',
        'main.go',
    ]
    ...
    if handle_clean_arg(GENERATED_FILES, "Golang substrate: Removes generated Go code and test outputs"):
        return
