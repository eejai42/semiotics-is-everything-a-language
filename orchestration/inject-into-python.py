#!/usr/bin/env python3
"""
Generate Python representation from the Effortless Rulebook.

This script runs from /language-candidates/python/ and reads
...
def main():
    ...
    write_readme(
        candidate_name,
        "Python code generation from the Effortless Rulebook.\n\n"
        "Future implementation will generate Python classes, "
